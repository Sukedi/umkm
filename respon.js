...
function GetResponse(txt){
    ...
    if (ada(["profil"],txt)){ 
        ...
        "Produk kami berupa minuman herbal dan kuliner. Sedangkan jasa kami berupa developing program dan edukasi komputer. Kami sudah memulai usaha sejak tahun 2021."; }
